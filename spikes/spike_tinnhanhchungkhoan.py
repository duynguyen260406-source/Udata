"""Spike: Tin nhanh chứng khoán (tinnhanhchungkhoan.vn).

NOTE: robots.txt blocks /api/ — so we do NOT touch /api/. RSS is allowed.
Strategy: RSS first, fallback static HTML + trafilatura.
Run: .venv\\Scripts\\python.exe spikes\\spike_tinnhanhchungkhoan.py
"""
...
RSS_CANDIDATES = [
    "https://www.tinnhanhchungkhoan.vn/chung-khoan.rss",
    "https://www.tinnhanhchungkhoan.vn/rss/chung-khoan.rss",
    "https://www.tinnhanhchungkhoan.vn/rss/home.rss",
    "https://www.tinnhanhchungkhoan.vn/doanh-nghiep.rss",
    "https://www.tinnhanhchungkhoan.vn/rss.html",
]
...
def try_html() -> bool:
    ...
    r = get("https://www.tinnhanhchungkhoan.vn/chung-khoan/")
